...
print("Now run all three lines at once by selecting them or hitting the green play triangle")
...
There are two lines of code in the block below; the first will allow you to check your working directory and the second will allow you to set your working directory, if you ever need to change it. If you do need to change your working directory, use the `setwd()` function. As you can see, we've provided you with some template text that you can replace with a file path specific to your computer. 

# -*- coding: utf-8 -*-
"""word2vec-visualization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KVCbC7fyhBRZICSM5qmou_vhRVMXue4k
...
if focus_word is not None:
    ...
    # define a variable neighbors which holds the top 'n' most similar words to the focus word, we'll use 10 for now
    neighbors = model.wv.most_similar(focus_word, topn = 10)
